//
//  NaturalBaseViewController.swift
//  DataSyncTools
//
...
class NaturalBaseViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    
    var table:UITableView! = UITableView()
    var titles:NSArray = ["CRUD API","Query"]
